<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <button wire:click="create()" class="bg-brand-gray hover:bg-brand-gray/80 text-white font-bold py-2 px-4 rounded my-3">Create New Product</button>
                ...
                <tbody>
                    ...
                    <tr class="border-b dark:border-gray-700">
                        ...
                        <td class="border px-4 py-2">
                            <button wire:click="edit({{ $product->id }})" class="bg-brand-gray hover:bg-brand-gray/80 text-white font-bold py-1 px-2 rounded">Edit</button>
                            <button wire:click="delete({{ $product->id }})" class="bg-brand-red hover:bg-brand-red/80 text-white font-bold py-1 px-2 rounded">Delete</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
