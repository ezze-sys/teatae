            ...
            <form>
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="sku" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">SKU:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="sku" wire:model="sku">
                        ...
                        <div class="mb-4">
                            <label class="inline-flex items-center">
                                <input type="checkbox" class="form-checkbox" wire:model="is_stock_managed">
                                <span class="ml-2 text-gray-700 dark:text-gray-300">Manage Stock?</span>
                            </label>
                        </div>
                        @if($is_stock_managed)
                        <div class="mb-4">
                            ...
                            @error('stock') <span class="text-brand-red">{{ $message }}</span>@enderror
                        </div>
                        @endif
                    </div>
                </div>
